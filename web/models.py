...
class ClassList(models.Model):
    school = models.ForeignKey(to=School, verbose_name='校区', on_delete=models.CASCADE)
    ...
    graduate = models.DateField(verbose_name='毕业日期', null=True, blank=True)
    ...
    tech_teacher = models.ManyToManyField(verbose_name='任课老师', to=UserInfo, related_name='tech_classes',
                                          blank=True, limit_choices_to={
            "depart__title__in": ["Python教学部", "Linux教学部"]})
...
class CounsultRecord(models.Model):
